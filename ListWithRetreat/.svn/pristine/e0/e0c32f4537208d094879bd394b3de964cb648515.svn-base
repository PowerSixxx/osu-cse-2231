 ...
 *    // 相当于(leftSequence, rightSequence)
 * </pre>
 *
...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        // TODO - fill in body
        // Create a new Node called newNode and insert the data x
        Node newNode = new Node();
        newNode.data = x;
        // Insert newNode and let newNode's next node point out to the first right node.
        newNode.next = this.lastLeft.next;
        newNode.previous = this.lastLeft;
        // Change lastLeft's next direction to the newNode
    ...
    public final T removeRightFront() {
        ...
        // TODO - fill in body
        // Get the first element in right sequence
    ...
    public final void moveToStart() {
        ...
        // TODO - fill in body
        // Move the cursor to the first node and set left length = 0
        this.lastLeft = this.preStart;
    ...
    public final void moveToFinish() {
        ...
        // TODO - fill in body
        // Move the cursor to the node before the last and set right length = 0
    ...
    public final void retreat() {
        ...
        // TODO - fill in body
        // Move the cursor to the previous node and update the length respectively
