...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public NaturalNumber3(NaturalNumber n) {
        ...
        // Convert NaturalNumber to String
        String s = n.toString();
        if (s.equals("0")) {
            this.rep = "";
        } else {
    ...
    public final void multiplyBy10(int k) {
        ...
        // Define if original number = 0, and k also = 0
    ...
    public final int divideBy10() {
        int removed = 0;
        if (this.rep.length() != 0) { // If rep is not empty, return is last number
            removed = this.rep.charAt(this.rep.length() - 1) - '0';
