...
public final class Program1PrettyPrint1 extends Program1 {
    ...
    public void prettyPrint(SimpleWriter out) {
        ...
        Map<String, Statement> newC = this.newContext();
        ...
        while (context.size() > 0) {
            Pair<String, Statement> p = context.removeAny();
            newC.add(p.key(), p.value());
            String name = p.key();
            Statement instructionBody = p.value();
            ...
            instructionBody.prettyPrint(out, INDENT_SIZE * 2);
