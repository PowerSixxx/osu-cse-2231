...
public abstract class StackTest {
    ...
    @Test
    public final void testPushMultipleSequence() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("one");
        Stack<String> sExpected = this.createFromArgsRef("three", "two", "one");
        /*
         * Call method under test
         */
        s.push("two");
    ...
    @Test
    public final void testPopMultipleUntilEmpty() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("green", "red", "blue");
    ...
    @Test
    public final void testLengthAfterMixedOperations() {
        Stack<String> s = this.createFromArgsTest("p", "q", "r"); // top="p"
        Stack<String> sExpected = this.createFromArgsRef("s", "q", "r");
    ...
    @Test
    public final void testLengthDuplicate() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("dup");
        Stack<String> sExpected = this.createFromArgsRef("dup", "dup");
        /*
         * Call method under test
         */
        s.push("dup");
