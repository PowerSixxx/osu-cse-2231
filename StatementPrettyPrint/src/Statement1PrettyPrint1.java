    ...
    public void prettyPrint(SimpleWriter out, int offset) {
        ...
        switch (this.kind()) {
            ...
            case IF: {
                ...
                Condition ifCondition = this.disassembleIf(ifBody);
                ...
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIf(ifCondition, ifBody);
            ...
            case IF_ELSE: {
                ...
                Condition ifElseCondition = this.disassembleIfElse(ifBody, elseBody);
                printSpaces(out, offset);
                ...
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIfElse(ifElseCondition, ifBody, elseBody);
            ...
            case WHILE: {
                ...
                // TODO - fill in case
                Statement whileBody = this.newInstance();
                Condition whileCondition = this.disassembleWhile(whileBody);
                printSpaces(out, offset);
                out.println("WHILE " + toStringCondition(whileCondition) + " DO");
                whileBody.prettyPrint(out, offset + indent);
                printSpaces(out, offset);
                out.println("END WHILE");
                this.assembleWhile(whileCondition, whileBody);
